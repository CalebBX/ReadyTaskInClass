...
namespace ReadyTask.Migrations
{
    ...
    [Migration("20191105175611_AddedProfileImageName")]
    partial class AddedProfileImageName
    {
            ...
            modelBuilder.Entity("ReadyTask.Models.ReadyTaskUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 100, AccessFailedCount = 0, ConcurrencyStamp = "ae0f8a11-d52f-4e3b-84aa-06155595ce99", Email = "user@test.com", EmailConfirmed = true, FirstName = "John", LastName = "Doe", LockoutEnabled = false, NormalizedEmail = "USER@TEST.COM", NormalizedUserName = "USER@TEST.COM", PasswordHash = "AQAAAAEAACcQAAAAEJI6eVyWppFmj+I/Bw9r1pnag6O9k21Q547msj6AUYz2HaFQxtBcg2UHPKrunwd9og==", PhoneNumberConfirmed = false, SecurityStamp = "", TwoFactorEnabled = false, UserName = "user@test.com" }
                    );
                });
            ...
            modelBuilder.Entity("ReadyTask.Models.ReadyTaskUserRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "83d3fa4e-2410-4d9b-9e7e-9d82f35db761", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = 2, ConcurrencyStamp = "eccdbafa-ee79-4b45-9571-3dbebed1764a", Name = "Manager", NormalizedName = "MANAGER" },
                        new { Id = 3, ConcurrencyStamp = "46b946fb-88af-48fa-a0ae-8bdc8f7b7bfc", Name = "Dev", NormalizedName = "DEV" }
                    );
                });
